...
export const WIDGETS = [
  ...
  { id: 'external-sort', title: 'External Merge Sort', blurb: 'Sort 100 GB with 1 GB of RAM: runs, merges, and IO cost.', accent: '#10b981', tag: 'M3', ready: true },
  ...
  { id: 'lsm', title: 'LSM Tree / SSTables', blurb: 'Memtable flushes, compaction, and a read path with bloom filters.', accent: '#10b981', tag: 'M3B', ready: true },
  ...
  { id: 'hashring', title: 'Consistent Hashing Ring', blurb: 'Add and remove nodes; see how few keys move, and play with quorums.', accent: '#ec4899', tag: 'M5', ready: true },
];
